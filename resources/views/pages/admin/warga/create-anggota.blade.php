...
<div x-data="{ pageName: `Tambah Anggota Keluarga`}">
...
<div class="mt-6 space-y-6">
    ...
    <form action="{{ route('admin.warga.anggota.store', $kartuKeluarga->id) }}" method="POST">
        @csrf
        ...
        <div class="flex justify-end gap-3 mt-5">
            ...
            <a    href="{{ route('admin.warga.show', $kartuKeluarga->id) }}"
